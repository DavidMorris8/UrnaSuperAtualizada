...
public class InterfaceUrna extends javax.swing.JFrame implements Interface{
    ...
    Candidato candidato13 = new Candidato("Lula", "PT", "Geraldo Alckmin", 13);
    Candidato candidato22 = new Candidato("Jair Bolsonaro", "PL", "Braga Netto", 22);
    Candidato candidato12 = new Candidato("Ciro Gomes", "PDT", "Ana Paula Matos", 12);
    Candidato candidato15 = new Candidato("Simone Tebet", "MDB", "Maria Gabrilli", 15);
    ...
    public void aparecerInformações(){
        switch(txtNum.getText()){
            case "13" -> {
                lblNome.setText(candidato13.getNome());
                lblPartido.setText(candidato13.getPartido());
                lblVice.setText(candidato13.getVice());
                lblPresidente.setIcon(Lula);
                lblVicePresidente.setIcon(Geraldo);
            }
            case "22" -> {
                lblNome.setText(candidato22.getNome());
                lblPartido.setText(candidato22.getPartido());
                lblVice.setText(candidato22.getVice());
                lblPresidente.setIcon(Bolsonaro);
                lblVicePresidente.setIcon(BragaNetto);
            }
            case "12" -> {
                lblNome.setText(candidato12.getNome());
                lblPartido.setText(candidato12.getPartido());
                lblVice.setText(candidato12.getVice());
                lblPresidente.setIcon(Ciro);
                lblVicePresidente.setIcon(Ana);
            }
            case "15" -> {
                lblNome.setText(candidato15.getNome());
                lblPartido.setText(candidato15.getPartido());
                lblVice.setText(candidato15.getVice());
    ...
    public void computarVotos(){
        switch(txtNum.getText()){
            case "13" -> {
                addVoto(candidato13);
                candidato13.setVotos();
                JOptionPane.showMessageDialog(rootPane, "Voto computado!");
            }
            case "12" -> {
                addVoto(candidato12);
                candidato12.setVotos();
                JOptionPane.showMessageDialog(rootPane, "Voto computado!");
            }
            case "22" -> {
                addVoto(candidato22);
                candidato22.setVotos();
                JOptionPane.showMessageDialog(rootPane, "Voto computado!");
            }
            case "15" -> {
                addVoto(candidato15);
                candidato15.setVotos();
                JOptionPane.showMessageDialog(rootPane, "Voto computado!");
            }
            case "00" -> {
                addVoto(votoNulo);
    ...
    public void novaVotacao(){
        ...
        candidato13.setVotos1(0);
        candidato22.setVotos1(0);
        candidato12.setVotos1(0);
        candidato15.setVotos1(0);
    ...
    @Override
        ...
        this.candidato.add(candidato13);
        this.candidato.add(candidato22);
        this.candidato.add(candidato12);
        this.candidato.add(candidato15);
    ...
    @Override
        ...
        if(votosComputados.isEmpty()){
            ...
            listaCandidatos();
            exibir += "Candidatos computados: \n" + candidato + "\n \n \n";
            exibir += candidato13.getNome()+" possui: "+candidato13.getVotos()+" votos válidos!\n";
            exibir += candidato22.getNome()+" possui: "+candidato22.getVotos()+" votos válidos!\n";
            exibir += candidato12.getNome()+" possui: "+candidato12.getVotos()+" votos válidos!\n";
            exibir += candidato15.getNome()+" possui: "+candidato15.getVotos()+" votos válidos!\n";
    ...
    private void initComponents() {
        ...
        lblImg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/justiçaeleitoral.jpg"))); // NOI18N

        btnInfo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/info.jpg"))); // NOI18N
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/duvida.jpg"))); // NOI18N
